...
/// Please see the documentation for <a href="../Protocols/MKPPlayerEventListener.html">MKPPlayerEventListener</a> for details on different events.
SWIFT_CLASS("_TtC8MKPlayer16MKPAdMarkerEvent")
...
/// Please see the documentation for <a href="../Protocols/MKPPlayerEventListener.html">MKPPlayerEventListener</a> for details on different events.
SWIFT_CLASS("_TtC8MKPlayer15MKPDestroyEvent")
...
SWIFT_CLASS("_TtC8MKPlayer9MKPPlayer")
@interface MKPPlayer : MKPPlayerEventDispatcher
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface MKPPlayer (SWIFT_EXTENSION(MKPlayer))
/// :nodoc:
...
@interface MKPPlayer (SWIFT_EXTENSION(MKPlayer)) <NSXMLParserDelegate>
/// :nodoc:
...
/// Please see the documentation for <a href="../Protocols/MKPPlayerEventListener.html">MKPPlayerEventListener</a> for details on different events.
SWIFT_CLASS("_TtC8MKPlayer24MKPRenderFirstFrameEvent")
